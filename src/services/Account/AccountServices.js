...
export const createAccount = async (payload, setIsModalVisible, setAccounts) => {
...
export const updateAccount = async (accountId, payload, setIsModalVisible, setAccounts) => {
